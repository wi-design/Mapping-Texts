...
this.render_wcc();this.render_ner();this.render_topics();b.invokePlugins({parentEl:"#app-ds-view",plugins:["modal"]});b.toggleRows()},render_time:function(){var a=STANFORD.MAPPING_TEXTS.cached,b=STANFORD.MAPPING_TEXTS.helpers,c=new STANFORD.MAPPING_TEXTS.views.time_select_view({collection:a.epochs}),d=$(this.el).find("#time-select-view ").find("div");d.replaceWith(c.render().el);d=$(this.el).find("#time-select-view").find("div");a.jqui=d.find("select#valueAA, select#valueBB").selectToUISlider({labels:10});
a.select_aa=d.find("select#valueAA");a.select_bb=d.find("select#valueBB");b.invokePlugins({parentEl:"#time-select-view",plugins:["tooltip"]});a.select_aa.change(function(){console.log("change happened!!!!!!!")})},render_map:function(){this.render_pub_view();var a=new STANFORD.MAPPING_TEXTS.views.map_view,b=STANFORD.MAPPING_TEXTS.cached,c=STANFORD.MAPPING_TEXTS.helpers,d={mapTypeControlOptions:{mapTypeIds:[google.maps.MapTypeId.TERRAIN,google.maps.MapTypeId.ROADMAP,"Dark"]},navigationControlOptions:{style:google.maps.NavigationControlStyle.SMALL},
backgroundColor:"#E2E2E2",center:STANFORD.MAPPING_TEXTS.geocoding.texas,zoom:6,mapTypeId:google.maps.MapTypeId.TERRAIN},e,f=$("#map-view").find(".widget");$(this.el).find(f).html(a.render().el);e=new google.maps.Map($(this.el).find(f).get(0),d);e.mapTypes.set("Dark",new google.maps.StyledMapType([{featureType:"all",elementType:"all",stylers:[{invert_lightness:!0}]},{featureType:"administrative",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"road",elementType:"all",stylers:[{visibility:"off"}]}],
{name:"Dark"}));a=document.createElement("DIV");new function(a){a.style.padding="5px";var c=document.createElement("DIV");c.style.backgroundColor="white";c.style.borderStyle="solid";c.style.borderWidth="1px";c.style.cursor="pointer";c.style.textAlign="center";a.appendChild(c);a=document.createElement("DIV");a.style.fontFamily="Arial,sans-serif";a.style.fontSize="12px";a.style.paddingLeft="4px";a.style.paddingRight="4px";a.innerHTML="<b>Select All</b>";c.appendChild(a);b.controlUI=c;google.maps.event.addDomListener(c,
"click",function(){var a=b.pubs.size(),c;g.text()==="Unselect All"?(console.log("===SET from unselected to selected==="),g.html("Select All"),c=function(b,c){var d=b.get("circle_overlay");b.set({display:!1},{mode:"BULK_SELECT_OPT",fetch:a===c+1});d.setOptions({strokeColor:"#FF0000"})}):(console.log("===SET from selected to unselected==="),g.html("Unselect All"),c=function(b,c){var d=b.get("circle_overlay");b.set({display:!0},{mode:"BULK_SELECT_OPT",fetch:a===c+1});d.setOptions({strokeColor:"#CCFF33"})});
b.pubs.forEach(c)})}(a,e);var g=$(a).find("b");a.index=1;e.controls[google.maps.ControlPosition.TOP_LEFT].push(a);a=document.createElement("DIV");new function(a){a.style.padding="10px";var b=document.createElement("DIV");b.style.width="130px";b.style.padding="10px";b.style.backgroundColor="white";b.style.borderWidth="1px";b.style.borderStyle="solid";b.style.borderColor="#555";b.style.opacity="0.8";b.style.boxShadow="0 0 3px rgba(0,0,0,0.5) inset";a.appendChild(b);a=document.createElement("DIV");a.style.fontFamily=
...
strokeOpacity:0.6,strokeWeight:4,fillColor:"#000000",fillOpacity:0})).setMap(a)})(e);b.pubs.forEach(function(a){var b=c.normalize(a.get("city")),d=STANFORD.MAPPING_TEXTS.geocoding[b],b=a.get("pubs").length,f=2E4+b*5E3,d={clickable:!0,strokeColor:"#FF0000",strokeOpacity:0.8,strokeWeight:2,fillColor:"#FF0000",fillOpacity:0.35,map:e,center:d,radius:f,zIndex:1E6-f},b="<h6>"+a.get("city")+"</h6><p>Publications: "+b,g=new google.maps.InfoWindow({content:b}),h=new google.maps.Circle(d);a.set({circle_overlay:h});
google.maps.event.addListener(h,"mouseover",function(){g.setPosition(h.getCenter());g.open(e)});google.maps.event.addListener(h,"mouseout",function(){g.close()});google.maps.event.addListener(h,"click",function(){var b={fetch:!0,mode:"USER_CLICKED_OPT"};a.get("display")===!0?(console.log(a.get("city"),"circle clicked, *DISPLAYED*"),a.set({display:!1},b),h.setOptions({strokeColor:"#FF0000"})):(console.log(a.get("city"),"circle clicked, *NOT DISPLAYED*"),a.set({display:!0},b),h.setOptions({strokeColor:"#CCFF33"}))})})},
render_pub_view:function(){var a=new STANFORD.MAPPING_TEXTS.views.pub_view;$(this.el).find("#pub-view .widget").html(a.render().el)},render_wcc:function(){var a=STANFORD.MAPPING_TEXTS.helpers,b=STANFORD.MAPPING_TEXTS.cached.wcc_collection,c=data=b.pluck("count"),d=labels=b.pluck("word"),e=$(this.el).find("#wcc-view .box").width(),d=a.make_tag_cloud(d,c),b=new STANFORD.MAPPING_TEXTS.views.wcc_view({collection:b,tags:d});$(this.el).find("#wcc-view").html(b.render().el);a.invokePlugins({parentEl:"#wcc-view",
...
$(function(){STANFORD.MAPPING_TEXTS.views.map_view=Backbone.View.extend({tagName:"div",events:{},initialize:function(){console.log("map_view view created")},render:function(){var a=Mustache.to_html(STANFORD.MAPPING_TEXTS.config.templates.map_view,{});$(this.el).html(a);return this}})});
$(function(){STANFORD.MAPPING_TEXTS.views.pub_view=Backbone.View.extend({tagName:"div",className:"inner",events:{'click label[data-checkbox="check-all"]':"city_label_clicked",'change [data-checkbox="check-all"]':"city_cb_change",'change [data-checkbox="pub-check"]':"pub_cb_change",'click [data-details="details"] [data-details="summary"]':"disclosureWidget"},initialize:function(){console.log("pub_view view created")},render:function(){var a=STANFORD.MAPPING_TEXTS.cached,a=Mustache.to_html(STANFORD.MAPPING_TEXTS.config.templates.pub_view,
{y1:a.selected_year_range.y1,y2:a.selected_year_range.y2});$(this.el).html(a);return this},city_label_clicked:function(){},city_cb_change:function(a){var b=this,c=STANFORD.MAPPING_TEXTS.cached,d={mode:"BULK_SELECT_OPT",fetch:!1},e={mode:"BULK_SELECT_OPT",fetch:!0},f=$(a.target),a=f.is(":checked"),f=f.parent().next("ul").find("li input"),g=f.size(),i=function(a){var f=b.get_pubseq($(this));$(this).attr("checked","checked");a===g-1?c.pubs.set_pubseq(f,!0,e):c.pubs.set_pubseq(f,!0,d)},j=function(a){var f=
b.get_pubseq($(this));$(this).removeAttr("checked");a===g-1?c.pubs.set_pubseq(f,!1,e):c.pubs.set_pubseq(f,!1,d)};console.log("city cb all change.");f.each(a?i:j)},pub_cb_change:function(a){var b=STANFORD.MAPPING_TEXTS.cached,c=$(a.target),a=c.is(":checked"),c=this.get_pubseq(c);b.pubs.set_pubseq(c,a,{mode:"USER_CLICKED_OPT",fetch:!0})},disclosureWidget:function(a){$(a.target).next('[data-details="content"]').animate({height:"toggle"},"fast").closest('[data-details="details"]').toggleClass("open")},
get_pubseq:function(a){return a.attr("id").split("-")[1]}})});
$(function(){STANFORD.MAPPING_TEXTS.views.time_select_view=Backbone.View.extend({tagName:"div",className:"time-select-navs",events:{slidestop:"slider_updated","click .epoch a":"epoch_updated"},initialize:function(){console.log("time_select_view view created")},render:function(){var a=STANFORD.MAPPING_TEXTS.config.templates.time_select_view,b=STANFORD.MAPPING_TEXTS.config,c={epochs:this.collection.toJSON(),_1800s:_.range(b.start,1900),_1900s:_.range(1900,2E3),_2000s:_.range(2E3,b.end+1)},a=Mustache.to_html(a,
